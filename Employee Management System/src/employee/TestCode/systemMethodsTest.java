...
public class systemMethodsTest {
    ...
    public void testAddEmployee() {
      assertEquals(Arrays.asList("1", "Afra", "20","2","John","22","3","Tom","24"), m.AddEmployee());
    }
    ...
    public void testUpdateEmployee(){
      ...
      assertEquals("Anna",m.UpdateEmployee());    
    ...
    public void testSearchEmployee(){
       ...
       assertEquals(Arrays.asList("1","Afra", "20","2","John","22","3","Tom","24").contains("Afra"), m.SearchEmployee());
