...
class Add_Employee implements ActionListener{
    ...
    Add_Employee(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("employee/icons/add_employee_page.jpg"));
        id15.setIcon(img);
    ...
    public void actionPerformed(ActionEvent ae){
     ...
     public String addEmp(String [] s ){
      ...
      if(count==s.length){
        return "All datas added successfully";
      }
      return "Error in adding the datas";
